...
## surrounded: close shadows eat the wave and get shoved by their mass.

const DISPLAY_NAME := "Nova Burst"
const ID := "nova"

const LEVELS := [
	{"interval": 3.2, "range": 120.0, "damage": 2, "shove": 40.0},
	{"interval": 2.9, "range": 135.0, "damage": 2, "shove": 44.0},
	{"interval": 2.6, "range": 150.0, "damage": 3, "shove": 48.0},
	{"interval": 2.3, "range": 168.0, "damage": 3, "shove": 54.0},
	{"interval": 2.0, "range": 190.0, "damage": 4, "shove": 60.0},
]
...
func upgrade_note() -> String:
	return "%d dmg · r%d" % [_stats()["damage"], int(_stats()["range"])]
